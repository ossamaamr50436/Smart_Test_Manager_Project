...
export default async function SpecialistRejectedStudentsPage() {
  const user = await getCurrentUser();

  // عزل الصلاحيات: صفحة خاصة بأخصائي الاختبارات والمسؤول
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-1 text-muted-foreground">
          الطلاب الذين رفض رئيس الشؤون التعليمية اعتماد درجاتهم — راجع السبب وتابع التعامل معهم
        </p>
      </div>
