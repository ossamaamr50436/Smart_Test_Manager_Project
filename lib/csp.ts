...
export function buildCsp(nonce: string): string {
  ...
  return [
    ...
    "img-src 'self' data: blob: https://*.ufs.sh https://utfs.io https://*.ingest.uploadthing.com",
    "font-src 'self' data: https://fonts.gstatic.com",
    `connect-src 'self' https://fonts.googleapis.com https://fonts.gstatic.com https://*.ingest.uploadthing.com https://*.ufs.sh https://utfs.io ${pusherOrigins}`,
